# NOTE: this folder now is moved to firmware branch : it is only here to unblock 3rd party contractors for the build system : it will be removed again when this issue is resolved
