...
easy_install -q $EGGDIR/mock-1.0.1-py$PYVERSION.egg
easy_install -q $EGGDIR/argparse-1.2.1-py$PYVERSION.egg
easy_install -q $EGGDIR/unittest2-0.5.1-py$PYVERSION.egg
pip install -q --use-mirrors coverage doxypy python-daemon unittest-xml-reporting
echo "Installing pyserial egg"
easy_install -q $BASEDIR/../pyserial/dist/pyserial-2.7_mb2.1-py$PYVERSION.egg
